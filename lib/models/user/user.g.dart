  ...
  Iterable<Object> serialize(Serializers serializers, User object,
    ...
    final result = <Object>[
      ...
      serializers.serialize(object.karmaPoints,
          specifiedType: const FullType(int)),
      'hvnEarned',
      serializers.serialize(object.hvnEarned,
          specifiedType: const FullType(int)),
      'sessionCount',
      serializers.serialize(object.sessionCount,
          specifiedType: const FullType(int)),
      'currentStreak',
      serializers.serialize(object.currentStreak,
          specifiedType: const FullType(int)),
      'questCompletion',
      serializers.serialize(object.questCompletion,
          specifiedType: const FullType(int)),
      'isLive',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'karmaPoints':
          ...
          break;
        case 'hvnEarned':
          result.hvnEarned = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'sessionCount':
          ...
          break;
        case 'currentStreak':
          result.currentStreak = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'questCompletion':
          result.questCompletion = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'isLive':
...
class _$User extends User {
  ...
  _$User._(
    ...
    if (hvnEarned == null) {
      throw new BuiltValueNullFieldError('User', 'hvnEarned');
    }
    if (sessionCount == null) {
      throw new BuiltValueNullFieldError('User', 'sessionCount');
    }
    if (currentStreak == null) {
      throw new BuiltValueNullFieldError('User', 'currentStreak');
    }
    if (questCompletion == null) {
      throw new BuiltValueNullFieldError('User', 'questCompletion');
    }
    if (isLive == null) {
  ...
  bool operator ==(Object other) {
    ...
    return other is User &&
        ...
        hvnEarned == other.hvnEarned &&
        sessionCount == other.sessionCount &&
        currentStreak == other.currentStreak &&
        questCompletion == other.questCompletion &&
        isLive == other.isLive &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), account.hashCode), address.hashCode), chatId.hashCode), liveId.hashCode), status.hashCode), email.hashCode), name.hashCode), photoUrl.hashCode), bio.hashCode),
                                                                                experiencePoints.hashCode),
                                                                            karmaPoints.hashCode),
                                                                        hvnEarned.hashCode),
                                                                    sessionCount.hashCode),
                                                                currentStreak.hashCode),
                                                            questCompletion.hashCode),
                                                        isLive.hashCode),
                                                    isOnline.hashCode),
...
class UserBuilder implements Builder<User, UserBuilder> {
  ...
  int _hvnEarned;
  int get hvnEarned => _$this._hvnEarned;
  set hvnEarned(int hvnEarned) => _$this._hvnEarned = hvnEarned;
  ...
  set currentStreak(int currentStreak) => _$this._currentStreak = currentStreak;

  int _questCompletion;
  int get questCompletion => _$this._questCompletion;
  set questCompletion(int questCompletion) =>
      _$this._questCompletion = questCompletion;
  ...
  UserBuilder get _$this {
    if (_$v != null) {
      ...
      _hvnEarned = _$v.hvnEarned;
      _sessionCount = _$v.sessionCount;
      _currentStreak = _$v.currentStreak;
      _questCompletion = _$v.questCompletion;
      _isLive = _$v.isLive;
