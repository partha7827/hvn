...
class _$UserSerializer implements StructuredSerializer<User> {
  ...
  Iterable<Object> serialize(Serializers serializers, User object,
    ...
    if (object.lastTimeSeen != null) {
      result
        ..add('lastTimeSeen')
        ..add(serializers.serialize(object.lastTimeSeen,
            specifiedType: const FullType(DateTime)));
    }
    if (object.name != null) {
      result
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc(0, account.hashCode), accountCreationTime.hashCode), address.hashCode), badges.hashCode),
                                                                                chatId.hashCode),
                                                                            email.hashCode),
